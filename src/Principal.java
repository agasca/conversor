...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        while(busqueda !=7){ 
            ...
            busqueda = lectura.nextInt(); //probar matrix | top gun | bichos
            ...
            if(busqueda > 0){
                if (busqueda < 7){
                    ...
                    ConsultaTipoDeCambio tipoCambio = new ConsultaTipoDeCambio();
                        Rcd_RespEstructGral monedaTC = tipoCambio.buscaTipoCambio();
        ...
        System.out.println("Gracias Alure & Orcale One");
